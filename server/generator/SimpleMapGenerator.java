...
public class SimpleMapGenerator implements MapGenerator {
    ...
    private void createDebugUnits(Map map, Player player, Tile startTile,
        ...
        //Unit freeColonist = new ServerUnit(game, unit4, player, unitType);
        unitType = spec.getUnitType("model.unit.veteranSoldier");
        //Unit veteranSoldier = new ServerUnit(game, unit4, player, unitType);
        unitType = spec.getUnitType("model.unit.jesuitMissionary");
        //Unit jesuitMissionary = new ServerUnit(game, unit4, player, unitType);
        ...
        unitType = spec.getUnitType("model.unit.veteranSoldier");
        /*use this line under unitType assignments to add
         * these in. commenting out
         * other unit assignments to eliminate
         * spotBugs notes. can be added back easily.
         * 
